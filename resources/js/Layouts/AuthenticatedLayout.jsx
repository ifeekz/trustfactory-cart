            ...
            <nav className="sticky top-0 z-50 border-b border-gray-100 bg-white">
                            ...
                            <div className="hidden space-x-8 sm:ms-10 sm:flex">
                                ...
                                >
                                    <span className="relative inline-flex items-center">
                                        Cart
                                        {cartCount > 0 && (
                                            <span className="ml-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-red-600 text-xs font-semibold text-white">
                                                {cartCount}
                                            </span>
                                        )}
                                    </span>
                ...
                >
                    <div className="space-y-1 pb-3 pt-2">
                        <ResponsiveNavLink href="/">Products</ResponsiveNavLink>
